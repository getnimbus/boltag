        ...
        >
          ...
          <div className="flex flex-col gap-4">
            <div className="flex flex-col gap-1">
              ...
              <div className="text-base text-gray-500/75 dark:text-gray-500/95">
                ...
                <a
                  ...
                  target="_blank"
                  className="ml-1 underline cursor-pointer transition-all hover:text-[#1e96fc] text-[#00000099] dark:text-gray-400 hover:dark:text-[#1e96fc]"
                >
                  Detail
                </a>
              </div>
            ...
            <div className="h-full border px-3 py-2 rounded-[8px] flex justify-between items-center gap-1">
              ...
              {token.length !== 0 && (
                <div
                  className="flex-1 cursor-pointer text-[#00000099] dark:text-gray-400"
