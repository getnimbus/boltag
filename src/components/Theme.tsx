...
export default function Theme() {
  ...
  return (
    <div className="flex items-center md:gap-1 gap-[5px] p-1 bg-gray-100 rounded-lg dark:bg-[#212121]">
      <button
        onClick={() => setTheme("light")}
        className={`md:p-1 p-[5px] rounded-md transition-all duration-200 ${
          theme === "light"
