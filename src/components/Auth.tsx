  ...
  return (
    <>
      <div className="relative">
        ...
        >
          ...
          (suiWalletInstance as WalletState).connected ? (
            <div className="flex items-center gap-2">
              ...
              >
                <g clip-path="url(#clip0_1790_28273)">
                  <path
        ...
        {openPopover ? (
          <div className="popover xl:w-[200px] xl:min-w-[200px] xl:max-h-[310px] max-h-[380px] md:w-[300px] md:min-w-[300px] w-[240px] min-w-[240px] mt-2 right-0">
            <div
