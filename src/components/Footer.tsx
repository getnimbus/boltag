...
export const Footer = () => {
  ...
  return (
    <div
      className="w-full pt-4 pb-6 bg-white dark:bg-black md:py-2"
      ...
      <div className="flex md:flex-row flex-col gap-6 md:items-center justify-between max-w-[1600px] m-auto xl:w-[88%] w-[90%]">
        <div className="flex items-center justify-between">
          <div className="flex items-center">
            <div className="flex items-center -ml-4">
              ...
              <div className="-ml-2 font-medium dark:text-white">Bolt</div>
            </div>
        ...
        <div className="flex items-center gap-6">
          ...
          <div className="flex items-center gap-4">
            <div className="text-sm dark:text-white">Find us on</div>
